...
impl InteractionProfile for Cv1Touch {
    fn properties(&self) -> &'static ProfileProperties {
        static DEVICE_PROPERTIES: ProfileProperties = ProfileProperties {
            model: Property::PerHand {
                left: c"Rift (CV1): Left Controller",
                right: c"Rift (CV1): Right Controller",
            },
            openvr_controller_type: c"oculus_touch",
            render_model_name: Property::PerHand {
                left: c"oculus_cv1_controller_left",
                right: c"oculus_cv1_controller_right",
            },
            registered_device_type: Property::PerHand {
                left: c"oculus/WMTCL77A600N9B_Controller_Left",
                right: c"oculus/WMTCR77A6013SM_Controller_Right",
            },
            serial_number: Property::PerHand {
                left: c"WMTCL77A600N9B_Controller_Left",
                right: c"WMTCR77A6013SM_Controller_Right",
            },
            tracking_system_name: c"openhmd",
    ...
    fn profile_path(&self) -> &'static str {
        // this should be "/interaction_profiles/meta/touch_controller_rift_cv1",
        // but when I use that, I get ERROR_PATH_UNSUPPORTED.
        // Until I can do that, this profile will always be used instead of the
        // oculus_touch profile (Even for users on the quest, for whom that profile
        // should be used instead, such as quest 2 users), since this profile 
        // appears first in Profiles.get()
...
#[cfg(test)]
mod tests {
    use super::{InteractionProfile, Cv1Touch};
    ...
    fn verify_bindings() {
        ...
        let path = Cv1Touch.profile_path();
